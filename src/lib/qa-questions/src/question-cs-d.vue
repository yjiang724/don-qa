...
export default {
  ...
  methods: {
    ...
    onSubmitEventHandler () {
      ...
      this.$emit('callback', {'QuesOptionValues': '1,5', 'QuesOptionTexts': '是,否', 'questionID': this.select, 'questionContent': '"' + content[0].quesText + '"一题，访员提问是否符合题目原意？', 'questionSn': this.input, 'QuesType': '3003'})
    }
  }
}
</script>
