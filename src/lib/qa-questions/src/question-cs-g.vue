...
export default {
  ...
  methods: {
    ...
    onSubmitEventHandler () {
      ...
      this.$emit('callback', {'QuesOptionValues': '1,5', 'QuesOptionTexts': '是,否', 'questionID': this.select, 'questionContent': '"' + content[0].quesText + '"一题，受访者第一次给出的答案是否准确？', 'questionSn': this.input, 'QuesType': '3006'})
    }
  }
}
</script>
