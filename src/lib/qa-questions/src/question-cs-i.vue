...
export default {
  ...
  methods: {
    ...
    onSubmitEventHandler () {
      ...
      this.$emit('callback', {'QuesOptionValues': '1,5', 'QuesOptionTexts': '是,否', 'questionID': this.select, 'questionContent': '访员是否提问了"' + content[0].quesText + '"一题相关内容？', 'questionSn': this.inputSn, 'QuesType': '3008'})
    }
  }
}
</script>
